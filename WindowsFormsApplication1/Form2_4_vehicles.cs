...
{
    public partial class Form2_4_vehicles : Form
    {
        ...
        public Form2_4_vehicles(int y,Form2 f2)
            : this()
        {
        ...
        private void final_submit_Click(object sender, EventArgs e)
        {
            ...
            if (cnt == (items + 1))
            {
                ...
                form2.recieve[1] = temporary; //Stores all license numbers in form2
                this.Close();
            }
